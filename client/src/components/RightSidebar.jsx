...
export default function RightSidebar() {
  ...
  return (
    //  <div className="w-50 h-screen bg-graph-paper sticky text-[14px] flex flex-col border-l-2">
    ...
    //   </div>
     ...
     <div className="w-50 h-screen bg-graph-paper sticky flex flex-col border-l-2">
      ...
      <div className="p-4 bg-graph-paper h-full border-black space-y-3 bg-zinc-50">
